...
from constants import CHECKPOINT_DIR2
...
if __name__ == '__main__':
  ...
  saver2 = tf.train.Saver(max_to_keep=10, var_list=global_network.get_vars_pre_traied())
  ...
  def train_function(parallel_index):
    ...
    while global_t < MAX_TIME_STEP and not stop_requested:
      ...
      if parallel_index == 0 and global_t - last_global_t > 1000000:
        ...
        saver2.save(sess, CHECKPOINT_DIR2 + '/' + 'checkpoint', global_step = global_t)
